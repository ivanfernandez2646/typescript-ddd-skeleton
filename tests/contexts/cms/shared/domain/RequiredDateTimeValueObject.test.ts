...
describe('RequiredDateTimeValueObject', () => {
  it('should throw an InvalidArgumentError if value is null', () => {
    expect(() => RequiredDateTimeValueObjectMother.create(null as unknown as string)).toThrow(InvalidArgumentError);
  });
  ...
  it('should throw an InvalidArgumentError if value is an invalid date', () => {
    expect(() => RequiredDateTimeValueObjectMother.create(MotherCreator.word())).toThrow(InvalidArgumentError);
  });
